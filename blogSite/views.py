...
from blogSite.forms import PostForm, CommentForm
from django.utils import timezone
from django.contrib.auth.decorators import login_required
from django.contrib.auth.mixins import LoginRequiredMixin
from django.urls import reverse_lazy
from templates import blogSite
...
class DraftListView(LoginRequiredMixin, ListView):
    login_url = '/login/'
    redirect_field_name = 'blogSite/post_list.html'
    model = Post
...
def add_comments_to_post(request, pk):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            form = CommentForm()
            return render(request, 'blogSite/comments_form.html', {'form': form})
